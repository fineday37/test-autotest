...
# from models.ui_models import UiReports, UiReportDetail
from schemas.ui.ui_report import UiReportSaveSchema, UiReportQuery, UiReportId, UiReportDetailQuery
        ...
        for result in step_results:
            ...
            if result.ui_session_data:
                ...
                if ui_session_data.screenshot_file_base64:
                    try:
                        file_info = await FileServer.save_base64_file(ui_session_data.screenshot_file_base64,
