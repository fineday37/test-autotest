...
class Configs(BaseSettings):
    ...
    # redis
    REDIS_URI: Union[str, None] = Field(default='redis://:@47.92.76.123:6379/', env="REDIS_URI")  # redis

    # DATABASE_URI: str = "sqlite+aiosqlite:///./sql_app.db?check_same_thread=False"  # Sqlite(异步)
    DATABASE_URI: str = "mysql+asyncmy://root:kzg1814666@47.92.76.123/test-backend"  # MySQL(异步)
    ...
    # job beat
    beat_db_uri: Union[str, None] = Field(default=None, env="CELERY_BEAT_DB_URL")
