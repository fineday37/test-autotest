...
from apis.api import api_case, api_info, project, module, env, api_report, functions, data_source, mock
...
app_router.include_router(data_source.router, prefix="/dataSource", tags=["data_source"])
app_router.include_router(mock.router, prefix="/mock", tags=["mock"])
